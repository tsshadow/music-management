...
class TestSoundcloudBasicRun(unittest.TestCase):
    ...
    def test_run_basic(self, mock_subprocess, mock_ytdlp):
        dl_info = {'id': 'rije-moat-1', 'title': 'RIJE MOAT', 'uploader': 'Albino', 'webpage_url': 'https://soundcloud.com/albino_music/rije-moat-1', 'ext': 'mp3', 'filepath': '/tmp/soundcloud/Albino/RIJE MOAT.mp3'}
        enriched_info = {'id': 'rije-moat-1', 'title': 'RIJE MOAT', 'uploader': 'Albino', 'uploader_url': 'https://soundcloud.com/albino_music', 'original_url': 'https://soundcloud.com/albino_music/rije-moat-1', 'genre': 'Hardstyle', 'channel_id': 'albino_id'}
