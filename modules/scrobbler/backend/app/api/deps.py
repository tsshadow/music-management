...
def get_analyzer_library_stats_service(request: Request) -> AnalyzerLibraryStatsService:
...
def get_analyzer_library_admin_service(request: Request) -> AnalyzerLibraryAdminService:
