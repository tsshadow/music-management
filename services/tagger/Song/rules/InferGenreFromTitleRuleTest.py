...
from services.tagger.Song.rules.InferGenreFromTitleRule import InferGenreFromTitleRule
...
class InferGenreFromTitleRuleTest(unittest.TestCase):
    ...
    def test_detects_multiple_genres(self):
        ...
        result = self.rule.apply(self.song)
        self.assertTrue(result)
        self.song.tag_collection.add.assert_has_calls([call(GENRE, 'Hardstyle'), call(GENRE, 'House')], any_order=True)
