<script lang="ts">
  ...
  async function loadConfig() {
    const res = await fetch(scrobblerApi.url('/config'));
    if (res.ok) {
  ...
  async function runExport() {
    ...
    try {
      ...
      const response = await fetch(scrobblerApi.url('/export/listenbrainz'), {
        method: 'POST',
        headers,
  ...
  async function deleteAllListens() {
    ...
    try {
      ...
      const response = await fetch(scrobblerApi.url('/listens'), {
        method: 'DELETE',
        headers
      });
      if (!response.ok) {
  ...
  async function deleteMediaLibrary() {
    ...
    try {
      ...
      const response = await fetch(scrobblerApi.url('/library'), {
        method: 'DELETE',
        headers,
      });
      if (!response.ok) {
