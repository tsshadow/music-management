...
async def subsonic_scrobble(u: str=Query(..., alias='u'), id: str=Query(..., alias='id'), time: int=Query(..., alias='time'), t: str | None=None, a: str | None=None, al: str | None=None, g: str | None=None, service: IngestService=Depends(get_ingest_service)):
