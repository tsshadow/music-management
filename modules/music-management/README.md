...
```bash
docker build -t music-management .
docker run -p 8001:8001 \
  -e DB_HOST=db -e DB_PORT=3306 -e DB_USER=music-management \
  -e DB_PASS=music-management -e DB_DB=music-management \
  music-management
```
...
services:
  db:
    ...
    environment:
      ...
      MARIADB_DATABASE: music-management
      MARIADB_USER: music-management
      MARIADB_PASSWORD: music-management
    volumes:
  ...
  music-management:
    ...
    environment:
      DB_HOST: db
      DB_PORT: 3306
      DB_USER: music-management
      DB_PASS: music-management
      DB_DB: music-management
