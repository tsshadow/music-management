<script lang="ts">
   ...
   */
  export let title = 'Most played tracks';
  export let description = 'See which tracks you keep replaying.';
  export let endpoint = scrobblerApi.url('/stats/tracks');
    ...
    <div class="table-wrapper">
      <table>
        ...
        <tbody>
          {#if rows.length === 0}
            <tr>
              <td colspan={columnCount} class="empty">No tracks found.</td>
            </tr>
          {:else}
            {#each rows as row}
              <tr>
