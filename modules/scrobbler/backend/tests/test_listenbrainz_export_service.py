...
async def test_listenbrainz_export_service_submits_payload():
    rows = [{'listen_id': 1, 'username': 'alice', 'listened_at': datetime(2024, 1, 1, tzinfo=timezone.utc), 'listen_duration': 185, 'source': 'test', 'source_track_id': 'track-1', 'track': {'id': 1, 'title': 'Track A', 'album': 'Album A', 'duration': 190, 'track_no': 1, 'disc_no': 1, 'mbid': '11111111-1111-1111-1111-111111111111', 'isrc': 'US-AAA-99-00001'}, 'artists': [{'name': 'Artist A', 'role': 'primary'}], 'listen_artists': ['Artist A'], 'genres': ['Rock']}, {'listen_id': 2, 'username': 'alice', 'listened_at': datetime(2024, 1, 2, tzinfo=timezone.utc), 'listen_duration': 200, 'source': 'test', 'source_track_id': None, 'track': {'id': 2, 'title': None, 'album': None, 'duration': None, 'track_no': None, 'disc_no': None, 'mbid': None, 'isrc': None}, 'artists': [], 'listen_artists': [], 'genres': []}]
