...
class AppSettings(BaseSettings):
    ...
    api_key: str | None = Field(default='Tarnish-Trespass-Dorsal-Sanding-Epilepsy-Unsavory9', alias='API_KEY')
    ...
    analyzer_default_paths: List[str] = Field(default_factory=list, alias='SCROBBLER_ANALYZER_PATHS')
    analyzer_scan_job_timeout: int = Field(default=21600, alias='SCROBBLER_ANALYZER_SCAN_JOB_TIMEOUT', ge=60)
    listenbrainz_base_url: str = Field(default='https://api.listenbrainz.org/1', alias='SCROBBLER_LISTENBRAINZ_BASE_URL')
    musicbrainz_base_url: str = Field(default='https://musicbrainz.org/ws/2', alias='SCROBBLER_MUSICBRAINZ_BASE_URL')
    musicbrainz_user_agent: str = Field(default='scrobbler/1.0 (+https://github.com/)', alias='SCROBBLER_MUSICBRAINZ_USER_AGENT')
