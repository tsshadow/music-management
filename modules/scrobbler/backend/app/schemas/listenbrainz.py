...
class ListenBrainzExportRequest(BaseModel):
    ...
    listen_type: Literal['single', 'import', 'playing_now'] = Field(default='import', description='ListenBrainz submission type')
    batch_size: int = Field(default=100, ge=1, le=100, description='Number of listens sent per API request')