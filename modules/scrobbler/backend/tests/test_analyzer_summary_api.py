...
async def test_analyzer_summary_endpoint(client):
    ...
    await repo.upsert_media_file(file_path='/music/morning-track.flac', file_size=12345, file_mtime=datetime.now(timezone.utc), audio_hash=None, duration=240, metadata={'source': 'test'})
